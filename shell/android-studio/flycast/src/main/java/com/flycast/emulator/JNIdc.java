...
public final class JNIdc
{
        ...
        public static native void guiSetInsets(int left, int right, int top, bottom);

        // Quest 3 VR native methods
        public static native boolean initVR(android.content.Context context, java.lang.Object activity);
        public static native void shutdownVR();
        public static native void updateVR();
        public static native void setVRGameMode(int mode);
        public static native void cycleVRGameMode();
        public static native int getVRGameMode();
        public static native boolean isVREnabled();
}
